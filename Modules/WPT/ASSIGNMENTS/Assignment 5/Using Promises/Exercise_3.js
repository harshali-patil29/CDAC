...
7. Print out the message from the above promise after it fulfills ("First promise chain complete!") 
...
9. Have this second promise return another ne
fulfill after 10 seconds with the message
"Second promise chain complete!"
10. Print out the message from the above prom
fulfills ("Second promise chain complete!")
HINT: Use setTimeout for the delay
HINT 2: This will be using the same promise two times:
